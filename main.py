...
async def upload(bot: Client, m: Message):
    ...
    await editable.edit("Now send the Thumb url/nEg » https://keephere.ru/get/-M7myhhV8jU/o/photo.jpg \n Or if don't want thumbnail send = no")
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
             ...
             id =  url.split("/")[-2]
             url =  "https://madxabhi-pw.onrender.com/" + id + "/master.m3u8?token={token}"
            ...
            try:  
                ...
                if "drive" in url:
                    try:
                        ...
                        copy = await bot.send_video(chat_id=m.chat.id,document=ka, caption=cc1)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
